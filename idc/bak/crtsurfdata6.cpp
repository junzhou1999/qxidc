...
int main(int argc, char *argv[])
{
  ...
  if (argc != 5 && argc != 6)
  {
    ...
    printf("Example:/project/idc/bin/crtsurfdata /project/idc/ini/stcode.ini /tmp/idc /logs/idc/crtsurfdata.log csv\n");
    printf(
        "Example:/project/idc/bin/crtsurfdata /project/idc/ini/stcode.ini /tmp/idc /logs/idc/crtsurfdata.log csv,xml\n");
    printf(
        "Example:/project/idc/bin/crtsurfdata /project/idc/ini/stcode.ini /tmp/idc /logs/idc/crtsurfdata.log csv 20240109211012\n");
